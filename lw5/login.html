...
<html lang="ru">
    ...
    <body>
        <div class="main">
            ...
            <div class="container">
                <img class="main-image" src="images/main-image.jpg" alt="Заглавная картинка" width="462px" height="501px">
                <form class="login-form" action="/home">
                    ...
                    <div class="login-form__password-wrapper">
                        ...
                        <img class="login-form__show-password-image" src="images/icons/eye-off.svg" alt="Скрывать пароль" width="24px" height="24px">
                    </div>
